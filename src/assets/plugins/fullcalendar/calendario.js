...
+function ($) {
  ...
  Calendario.DEFAULTS = {
    ...
    weekends: 'SAT, SUN',
    format: 'YYYY-mm-dd',
    feed:false// 'http://calendario.t15.org/sync/'
  }
...
var ii=this.year+"-"+this.options.months[this.month]+"-"+(day-1);
...
var v= formatDate(ii);
        cellClasses = (today ? 'fc-today  '+v : (past ? 'fc-past '+v: 'fc-future '+v)) +
  ...
  Calendario.prototype.feed = function() {
    return true;//this.syncData.feed ? this.syncData.feed : 'not-available'
  }
