...
<div id="content">
 ...
 <div class="navbar ">
   ...
   switch(trim(strtolower($this->layoutName))){
		...
		case 'import':  $title_page='Import file';break;   
		case 'nouvelle soumission':  $title_page='Gestion des modules';break;
		case 'module':  $title_page='Gestion des modules';break;	
		case 'detailsmodule':  $title_page='Gestion des PDF chapitres';break;
   }
